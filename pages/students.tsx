    ...
    <>
      ...
      <main className="min-h-screen">
        <section className="container-responsive py-6">
          <TextReveal as="h1" className="text-2xl sm:text-3xl font-bold tracking-tight">Students</TextReveal>
          <TextReveal as="p" className="mt-2 text-sm text-muted" delay={0.05}>Profiles of our classmates.</TextReveal>
          <div className="mt-6">
